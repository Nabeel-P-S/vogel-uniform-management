...
<h3><b style="font-size:30px;color:#2196f3;margin-left: 25vw;">Vogel Products</b>
 <!-- <button style="margin-left: 4vw;" class="btn btn-danger" onclick="order_list();">close</button> -->
         <a style="margin-left: 38vw;font-size: 1.5vw;" href="main.php"  class="w3-bar-item w3-button w3-hover-white"><button class="btn  btn-warning active" style="height: 2.5vw;"> EXIT</button></a> </h3>
