            ...
            <div id="detail_div">
             <div class="form-group field-wrapper required-field">
              ...
              <div class="col-md-8 inputGroupContainer">
               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-leaf"></i></span><input id="vendor_id" name="vendor_id" placeholder="Shop Number" class="form-control" required="" value="<?php echo $vendor_id;?>" type="text"></div>
             </div>
           </div>
   ...
   <div class="form-group">
    ...
    <div class="col-md-8 inputGroupContainer">
     <div class="input-group"><span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
      ...
      <select class="selectpicker form-control" id="vendor_district" name="vendor_district">
...
<div class="form-group field-wrapper required-field">
  ...
  <div class="col-md-8 inputGroupContainer">
   <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span><input id="vendor_email" name="vendor_email" placeholder="Email" class="form-control" required="true" value="" type="text"></div>
 </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <input id="vendor_mobile1" name="vendor_mobile1" type="text" placeholder="Mobile No 1" class="form-control input-md">
     ...
     <div class="form-group">
      <td>
        <select id="item_id"  name="item_id" class="form-control">
          ...
          <?php  
          $query=mysqli_query($conn,"SELECT item_id,item_name from items");
      ...
      <td>
        ...
        <input id="item_price1" style="width: 6vw;" name="item_price1" type="text" placeholder="0 to 12" class="form-control input-md">

      </td>
      <td>

        <input id="item_price2" style="width: 6vw;" name="item_price2" type="text" placeholder="12 to 25" class="form-control input-md">
     ...
     <div class="form-group">
      <td>
        <select id="fabric_id"  name="fabric_id" class="form-control">
          ...
          <?php  
          $query=mysqli_query($conn,"SELECT fabric_id,fabric from fabric");
...
<option style="color: grey" value="" >select addon</option>
            ...
            {
              ?>
              <option value="<?php echo $fetch ['addon_id']; ?>"><?php echo $fetch ['addon']." ".$fetch ['addon_id'];?> </option>
              <?php
            }
            ?> 
          </select>            
        ...
        <td>
          ...
          <input id="addon_price1" style="width: 6vw;"  name="addon_price1" type="text" placeholder="0 to 12" class="form-control input-md">

        </td>
        <td>

          <input id="addon_price2" style="width: 6vw;" name="addon_price2" type="text" placeholder="12 to 25" class="form-control input-md">
 ...
 <div class="well form-horizontal">
  <fieldset>
   ...
   <button type="button" style="margin-left: 3vw;" onclick="details_button()" class="btn btn-warning">
     ...
     <button type="button" style="margin-left: 3vw;" onclick="save_factory()" class="btn btn-primary ">Submit Form</button>
...
cell1.innerHTML ='<select id="item_id" class="form-control input-md" name="item_id"> <option style="color: grey" value="" >select Item</option><?php  
            ...
            {
              ?>
              <option value="<?php echo $fetch ['item_id']; ?>"><?php echo $fetch ['item_name']." ".$fetch ['item_id'];?> </option><?php
            }
            ?>    </select>';
...
<script type="text/javascript">
       ...
       if (addon_id!="")
        {
          ...
          addon_price1[m]=addon_price1;
          addon_price2[m]=addon_price2;
          addon_price3[m]=addon_price3;
  ...
  var fabric_array_json=JSON.stringify(fabric_array);
    var fabric_price_json=JSON.stringify(fabric_price);
