...
<body>
  <div class="col-md-12" id="full_div" style="padding: 0vw;">
    <div class="col-md-3">
    <nav class="w3-sidebar  w3-collapse  w3-large w3-padding" style="display: none; *z-index:3;width:295px;font-weight:bold;padding-left: 0vw; background-color:  #00549A;color:white" id="mySidebar"><br>
...
<!--      <b style="color: yellow;"> Hai <?php //echo $user_name;?></b> 
 -->      <div class="w3-container">
        <a><h3 class="w3-padding-64"><b><img src="images/vogel1.jpg" ></b></h3></a>
          <!-- <a><h3 class="w3-padding-64"><b><img style="margin-left: 2vw;" src="images/vogel13.jpg" ></b></h3></a> -->

      </div>
      <div class="w3-bar-block">
        <a href="#" onclick="home()" class="w3-bar-item w3-button w3-hover-white">Home</a> 
        <!-- <a href="#" onclick="indexpage()" class="w3-bar-item w3-button w3-hover-white">Home</a>  -->
...
<script>
  window.onload=<?php  if ($user_name=="admin") echo "home()"; else echo "my_function(2,6)"; ?>;
